...
export type CityQuery = { city: { id: string, nameAr: string, nameEn: string, status: CityStatus, updatedAt: any, createdAt: any, countryId: string, country?: { code: string, createdAt: any, dialCode?: string | null, id: string, nameAr: string, nameEn: string, updatedAt: any } | null } };
